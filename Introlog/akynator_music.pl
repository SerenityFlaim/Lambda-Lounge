...
rock(flyleaf, 1)
rock(lacey_sturm, 1)
rock(rivers&robots, 0)
rock(jonathan_ogden, 0)
rock(akina_sanat, 0)
rock(ledger, 1)
rock(kim_walker_smith, 0)
rock(for_king_&_country, 0)
rock(citizens, 1)
...
group(flyleaf, 1)
group(lacey_sturm, 0)
group(rivers&robots, 1)
group(jonathan_ogden, 0)
group(akina_sanat, 0)
group(ledger, 0)
group(kim_walker_smith, 0)
group(for_king_&_country, 1)
group(citizens, 1)
...
jazz(flyleaf, 0)
jazz(lacey_sturm, 0)
jazz(rivers&robots, 1)
jazz(jonathan_ogden, 0)
jazz(akina_sanat, 2)
jazz(ledger, 1)
jazz(kim_walker_smith, 0)
jazz(for_king_&_country, 0)
jazz(citizens, 0)
...
theme(flyleaf, 1)
theme(lacey_sturm, 1)
theme(rivers&robots, 2)
theme(jonathan_ogden, 2)
theme(akina_sanat, 0)
theme(ledger, 1)
theme(kim_walker_smith, 2)
theme(for_king_&_country, 2)
theme(citizens, 2)